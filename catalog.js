  ...
  artists: [
    {
      ...
      albums: [
        { id: 'fan-powers', title: 'Fan Powers', year: '', artClass: 'art-neon', tracks: [
          ...
          { id: 'zj-very-nice-to-see-you', title: 'Very nice to See You', duration: '—', src: githubFile('audio/z-j/very-nice-to-see-you.mp3') },
          { id: 'zj-in-the-night', title: 'In The Night', duration: '—', src: githubFile('audio/z-j/in-the-night.mp3') }
        ] }
      ]
    },
    {
      ...
      albums: [
        { id: 'classic-1', title: 'Classic #1', year: '', artClass: 'art-rooms', tracks: [
          { id: 'duke-winter-night', title: 'Winter Night', duration: '—', src: githubFile('audio/the-old-duke/winter-night.mp3') },
          { id: 'duke-dogs-and-cats', title: 'Dogs & Cats', duration: '—', src: githubFile('audio/the-old-duke/dogs-and-cats.mp3') },
          { id: 'duke-naturals', title: 'Naturals', duration: '—', src: githubFile('audio/the-old-duke/naturals.mp3') },
          { id: 'duke-peaceful-moment', title: 'Peaceful Moment', duration: '—', src: githubFile('audio/the-old-duke/peaceful-moment.mp3') },
          { id: 'duke-water', title: 'Water', duration: '—', src: githubFile('audio/the-old-duke/water.mp3') }
        ] }
      ]
    },
    {
      ...
      albums: [
        { id: 'until-we-laugh', title: 'Until We Laugh', year: '', artClass: 'art-sunday-service', tracks: [
          { id: 'weekdys-until-we-laugh', title: 'Until We Laugh', duration: '—', src: githubFile('audio/my-weekdys/until-we-laugh.mp3') },
          { id: 'weekdys-here-she-comes', title: 'Here she comes', duration: '—', src: githubFile('audio/my-weekdys/here-she-comes.mp3') },
          { id: 'weekdys-hangout', title: 'Hangout', duration: '—', src: githubFile('audio/my-weekdys/hangout.mp3') },
          { id: 'weekdys-hangback', title: 'Hangback', duration: '—', src: githubFile('audio/my-weekdys/hangback.mp3') },
          { id: 'weekdys-grateful', title: 'Grateful', duration: '—', src: githubFile('audio/my-weekdys/grateful.mp3') },
          { id: 'weekdys-happiness-has-no-cost', title: 'Happiness Has no Cost', duration: '—', src: githubFile('audio/my-weekdys/happiness-has-no-cost.mp3') },
          { id: 'weekdys-night', title: 'Night', duration: '—', src: githubFile('audio/my-weekdys/night.mp3') }
        ] }
      ]
    },
    {
      ...
      albums: [
        { id: 'great-times', title: 'Great Times', year: '', artClass: 'art-satellite', tracks: [
          { id: 'nova-centre-city-tour', title: 'Centre City Tour', duration: '—', src: githubFile('audio/nova-lane/centre-city-tour.mp3') },
          { id: 'nova-excellent-times', title: 'Excellent Times', duration: '—', src: githubFile('audio/nova-lane/excellent-times.mp3') },
          { id: 'nova-upon-the-name', title: 'Upon the Name', duration: '—', src: githubFile('audio/nova-lane/upon-the-name.mp3') },
          { id: 'nova-yippee', title: 'Yippee', duration: '—', src: githubFile('audio/nova-lane/yippee.mp3') }
        ] }
      ]
    }
  ]
